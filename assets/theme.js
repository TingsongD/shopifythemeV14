...
(function ($) {
    ...
    function themeRootPath(path) {
        var rootUrl = window.theme && window.theme.routes && window.theme.routes.root_url ? window.theme.routes.root_url : '/';

        return rootUrl.replace(/\/$/, '') + '/' + path.replace(/^\/+/, '');
    }

    function themeCartPath(path) {
        var cartUrl = window.theme && window.theme.routes && window.theme.routes.cart_url ? window.theme.routes.cart_url : '/cart';
        ...
        if ($(document).ajaxError) {
            $(document).ajaxError(function(event, xhr, settings, error) {
                ...
                if (window.ThemeDebug) {
                    ThemeDebug.warn('Global AJAX Error Interceptor:', settings.url, error);
                }
                
                // Handle unhandled errors
                if (!settings.hasErrorHandler && window.ThemeErrorHandler) {
                    ThemeErrorHandler.handleAjaxError(xhr, xhr.status, error, settings.url);
                }
            });
        }
    ...
    /* shopify.api.min.js */
    function floatToString(e, t) { var n = e.toFixed(t).toString(); return n.match(/^\.\d+/) ? "0" + n : n } function attributeToString(e) { return "string" != typeof e && (e += "", "undefined" === e && (e = "")), jQuery.trim(e) } "undefined" == typeof window.Shopify && (window.Shopify = {}), Shopify.money_format = "${{amount}}", Shopify.onError = function (e, t) { var n; try { n = JSON.parse(e.responseText); } catch (r) { n = { message: "Error", status: t || "", description: "Unable to parse response" }; } n.message ? alert(n.message + "(" + n.status + "): " + n.description) : alert("Error : " + Shopify.fullMessagesFromErrors(n).join("; ") + ".") }, Shopify.fullMessagesFromErrors = function (e) { var t = []; return jQuery.each(e, function (e, n) { jQuery.each(n, function (n, r) { t.push(e + " " + r) }) }), t }, Shopify.onCartUpdate = function (e) { alert("There are now " + e.item_count + " items in the cart.") }, Shopify.onCartShippingRatesUpdate = function (e, t) { var n = ""; t.zip && (n += t.zip + ", "), t.province && (n += t.province + ", "), n += t.country, alert("There are " + e.length + " shipping rates available for " + n + ", starting at " + Shopify.formatMoney(e[0].price) + ".") }, Shopify.onItemAdded = function (e) { alert(e.title + " was added to your shopping cart.") }, Shopify.onProduct = function (e) { alert("Received everything we ever wanted to know about " + e.title) }, Shopify.formatMoney = function (e, t) { function n(e, t) { return "undefined" == typeof e ? t : e } function r(e, t, r, i) { if (t = n(t, 2), r = n(r, ","), i = n(i, "."), isNaN(e) || null == e) return 0; e = (e / 100).toFixed(t); var o = e.split("."), a = o[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + r), s = o[1] ? i + o[1] : ""; return a + s } "string" == typeof e && (e = e.replace(".", "")); var i = "", o = /\{\{\s*(\w+)\s*\}\}/, a = t || this.money_format; switch (a.match(o)[1]) { case "amount": i = r(e, 2); break; case "amount_no_decimals": i = r(e, 0); break; case "amount_with_comma_separator": i = r(e, 2, ".", ","); break; case "amount_no_decimals_with_comma_separator": i = r(e, 0, ".", ",") }return a.replace(o, i) }, Shopify.resizeImage = function (e, t) { try { if ("original" == t) return e; var n = e.match(/(.*\/[\w\-\_\.]+)\.(\w{2,4})/); return n[1] + "_" + t + "." + n[2] } catch (r) { return e } }, Shopify.addItem = function (e, t, n) { var t = t || 1, r = { type: "POST", url: themeCartPath("/add.js"), data: "quantity=" + t + "&id=" + e, dataType: "json", success: function (e) { "function" == typeof n ? n(e) : Shopify.onItemAdded(e) }, error: function (e, t) { Shopify.onError(e, t) } }; jQuery.ajax(r) }, Shopify.addItemFromForm = function (e, t) { var n = { type: "POST", url: themeCartPath("/add.js"), data: jQuery("#" + e).serialize(), dataType: "json", success: function (e) { "function" == typeof t ? t(e) : Shopify.onItemAdded(e) }, error: function (e, t) { Shopify.onError(e, t) } }; jQuery.ajax(n) }, Shopify.getCart = function (e) { jQuery.getJSON(themeCartPath(".js"), function (t, n) { "function" == typeof e ? e(t) : Shopify.onCartUpdate(t) }) }, Shopify.pollForCartShippingRatesForDestination = function (e, t, n) { n = n || Shopify.onError; var r = function () { jQuery.ajax(themeCartPath("/async_shipping_rates"), { dataType: "json", success: function (n, i, o) { 200 === o.status ? "function" == typeof t ? t(n.shipping_rates, e) : Shopify.onCartShippingRatesUpdate(n.shipping_rates, e) : setTimeout(r, 500) }, error: n }) }; return r }, Shopify.getCartShippingRatesForDestination = function (e, t, n) { n = n || Shopify.onError; var r = { type: "POST", url: themeCartPath("/prepare_shipping_rates"), data: Shopify.param({ shipping_address: e }), success: Shopify.pollForCartShippingRatesForDestination(e, t, n), error: n }; jQuery.ajax(r) }, Shopify.getProduct = function (e, t) { jQuery.getJSON(themeRootPath("products/") + e + ".js", function (e, n) { "function" == typeof t ? t(e) : Shopify.onProduct(e) }) }, Shopify.changeItem = function (e, t, n) { var r = { type: "POST", url: themeCartPath("/change.js"), data: "quantity=" + t + "&id=" + e, dataType: "json", success: function (e) { "function" == typeof n ? n(e) : Shopify.onCartUpdate(e) }, error: function (e, t) { Shopify.onError(e, t) } }; jQuery.ajax(r) }, Shopify.removeItem = function (e, t) { var n = { type: "POST", url: themeCartPath("/change.js"), data: "quantity=0&id=" + e, dataType: "json", success: function (e) { "function" == typeof t ? t(e) : Shopify.onCartUpdate(e) }, error: function (e, t) { Shopify.onError(e, t) } }; jQuery.ajax(n) }, Shopify.clear = function (e) { var t = { type: "POST", url: themeCartPath("/clear.js"), data: "", dataType: "json", success: function (t) { "function" == typeof e ? e(t) : Shopify.onCartUpdate(t) }, error: function (e, t) { Shopify.onError(e, t) } }; jQuery.ajax(t) }, Shopify.updateCartFromForm = function (e, t) { var n = { type: "POST", url: themeCartPath("/update.js"), data: jQuery("#" + e).serialize(), dataType: "json", success: function (e) { "function" == typeof t ? t(e) : Shopify.onCartUpdate(e) }, error: function (e, t) { Shopify.onError(e, t) } }; jQuery.ajax(n) }, Shopify.updateCartAttributes = function (e, t) { var n = ""; jQuery.isArray(e) ? jQuery.each(e, function (e, t) { var r = attributeToString(t.key); "" !== r && (n += "attributes[" + r + "]=" + attributeToString(t.value) + "&") }) : "object" == typeof e && null !== e && jQuery.each(e, function (e, t) { n += "attributes[" + attributeToString(e) + "]=" + attributeToString(t) + "&" }); var r = { type: "POST", url: themeCartPath("/update.js"), data: n, dataType: "json", success: function (e) { "function" == typeof t ? t(e) : Shopify.onCartUpdate(e) }, error: function (e, t) { Shopify.onError(e, t) } }; jQuery.ajax(r) }, Shopify.updateCartNote = function (e, t) { var n = { type: "POST", url: themeCartPath("/update.js"), data: "note=" + attributeToString(e), dataType: "json", success: function (e) { "function" == typeof t ? t(e) : Shopify.onCartUpdate(e) }, error: function (e, t) { Shopify.onError(e, t) } }; jQuery.ajax(n) }, jQuery.fn.jquery >= "1.4" ? Shopify.param = jQuery.param : (Shopify.param = function (e) { var t = [], n = function (e, n) { n = jQuery.isFunction(n) ? n() : n, t[t.length] = encodeURIComponent(e) + "=" + encodeURIComponent(n) }; if (jQuery.isArray(e) || e.jquery) jQuery.each(e, function () { n(this.name, this.value) }); else for (var r in e) Shopify.buildParams(r, e[r], n); return t.join("&").replace(/%20/g, "+") }, Shopify.buildParams = function (e, t, n) { jQuery.isArray(t) && t.length ? jQuery.each(t, function (t, r) { rbracket.test(e) ? n(e, r) : Shopify.buildParams(e + "[" + ("object" == typeof r || jQuery.isArray(r) ? t : "") + "]", r, n) }) : null != t && "object" == typeof t ? Shopify.isEmptyObject(t) ? n(e, "") : jQuery.each(t, function (t, r) { Shopify.buildParams(e + "[" + t + "]", r, n) }) : n(e, t) }, Shopify.isEmptyObject = function (e) { for (var t in e) return !1; return !0 });
    ...
    Popups.prototype = $.extend({}, Popups.prototype, {
        load: function () {
            ...
            if ($popup.length) {
                    ...
                    if (json) {
                        ...
                        $.each(json.variants, function () {
                            if (this.id === current_id) {
                                $('#ContactFormProductUrl').attr('value', theme.domain + themeRootPath('products/' + json.handle + '?variant=' + current_id));
                ...
                $body.on('click', this.selectors.button, function (e) {
                    ...
                    ThemeDebug.log('[POPUP TRACK] Manual Open Click. Name:', name);
                ...
                $popup.on('click', this.selectors.button_close, function (e) {
                    ...
                    // Prevent duplicate close events from bubbling
                    e.stopImmediatePropagation();
                    e.preventDefault();

                    ThemeDebug.log('[POPUP TRACK] Manual Close Button Click. Name:', name);
                ...
                $popup.on('click', '[data-js-popup-name]:not([data-disable-bg-click])', function (e) {
                    ...
                    if ($t[0].hasAttribute('data-js-popup-name')) {
                        ...
                        // Prevent duplicate close calls from event bubbling
                        e.stopImmediatePropagation();
                        e.preventDefault();

                        ThemeDebug.log('[POPUP TRACK] Manual Close Background Click. Name:', name);
        ...
        callByName: function (name, $target) {
            ThemeDebug.log('[POPUP TRACK] callByName called. Name:', name, 'Trigger:', $target);
            var _ = this,
            ...
            function onCall() {
                ThemeDebug.log('[POPUP DEBUG] onCall() START at', Date.now());
                $popup.scrollTop(0);
                $body.addClass('popup-opened');

                // Unbind any stale transitionend handlers before setting up new one
                ThemeDebug.log('[POPUP DEBUG] onCall: Unbinding transitionend on $bg');
                $bg.unbind('transitionend');
                ThemeDebug.log('[POPUP DEBUG] onCall: Setting up OPEN transitionend handler');
                $bg.one('transitionend', function () {
                    ThemeDebug.log('[POPUP DEBUG] OPEN transitionend FIRED at', Date.now());
                ...
                setTimeout(function () {
                    ...
                    var $focusable = $content.find('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');
                    if ($focusable.length) {
            ...
            if ($content.length) {
                ...
                ThemeDebug.log('[POPUP DEBUG] callByName START for:', name, 'at', Date.now());
                ThemeDebug.log('[POPUP DEBUG] Unbinding transitionend on $bg');
                $bg.unbind('transitionend');
                // Reset close sequence when popup opens, so subsequent close can complete
                $content.data('close-sequence', 0);
                // LOCK MECHANISM: timestamp the open action
                $content.data('last-open-timestamp', Date.now());
                ThemeDebug.log('[POPUP DEBUG] Reset close-sequence to 0 and set open timestamp');
                ...
                if (!$content[0].hasAttribute('data-disable-esc-close')) {
        ...
        closeByName: function (name, $target, callback) {
            ThemeDebug.log('[POPUP TRACK] closeByName called. Name:', name, 'Trigger:', $target);
            var $popup = $(this.selectors.popup),
                $bg = $(this.selectors.bg),
                $content = $popup.find('[data-js-popup-name="' + name + '"]'),
            ...
            if ($content.length) {
                // LOCK MECHANISM: Prevent closing if opened less than 500ms ago
                // This blocks ANY ghost clicks, race conditions, or accidental triggers immediately after open.
                var lastOpen = $content.data('last-open-timestamp') || 0;
                var now = Date.now();
                if (now - lastOpen < 500) {

                    return false;
                }
                var guard = $content.attr('data-close-guard'),
                    $targetEl = $target ? ($target.jquery ? $target : $($target)) : null,
                    isCloseButton = $targetEl && ($targetEl.is(this.selectors.button_close) || $targetEl.closest(this.selectors.button_close).length);

                if (guard === 'button' && !isCloseButton) {
                    return false;
                }

                // DEFENSIVE: Prevent Add to Cart button from triggering interactions that close the popup
                // This fixes the race condition where the Add to Cart button click propagates/is captured 
                // and triggers closeByName immediately after callByName starts.
                if ($targetEl && ($targetEl.is('[data-js-product-button-add-to-cart]') || $targetEl.closest('[data-js-product-button-add-to-cart]').length)) {
                    console.warn('[POPUP DEBUG] closeByName BLOCKED - triggered by Add to Cart button/interaction', {
                        target: $targetEl[0],
                ...
                ThemeDebug.log('[POPUP DEBUG] closeByName - triggering close.before at', Date.now());
                $content.trigger(name + '.' + 'close.before', [$content, $target ? $target : null]);

                theme.Preloader.unset($popup);

                // Track this close sequence with an incrementing counter
                // This allows us to detect if popup was re-opened during close animation
                var closeSequence = ($content.data('close-sequence') || 0) + 1;
                $content.data('close-sequence', closeSequence);
                ThemeDebug.log('[POPUP DEBUG] closeByName - set close-sequence to:', closeSequence);

                ThemeDebug.log('[POPUP DEBUG] closeByName - Setting up CLOSE transitionend handler');
                // CRITICAL: Unbind any existing transitionend handlers to prevent stale handlers
                $bg.unbind('transitionend');
                $bg.one('transitionend', function () {
                    ThemeDebug.log('[POPUP DEBUG] CLOSE transitionend FIRED at', Date.now());
                    ThemeDebug.log('[POPUP DEBUG] Current close-sequence:', $content.data('close-sequence'), 'Expected:', closeSequence);
                    // Guard: Don't fire close.after if popup was re-opened during transition
                    // If the sequence changed, a new open/close cycle started
                    if ($content.data('close-sequence') !== closeSequence) {
                        ThemeDebug.log('[POPUP DEBUG] close.after SKIPPED - popup was re-opened during close transition');
                        return;
                    }

                    ThemeDebug.log('[POPUP DEBUG] close.after EXECUTING - removing classes');
        ...
        getProduct: function ($product, success) {
            ...
            if (handle) {
                this.ajax = $.ajax({
                    ...
                    url: themeRootPath('products/' + handle + variant_url),
                    data: {
                        view: 'quick-view'
                    },
                    dataType: 'html',
                    ...
                    error: function (xhr, status, error) {
                        if (window.ThemeErrorHandler) {
                            ThemeErrorHandler.handleAjaxError(xhr, status, error, 'Quick view fetch');
                        }
                    }
                });
            }
        ...
        setCustomerList: function (items, callback) {
            if (theme.customer) {
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        if (window.ThemeErrorHandler) {
                            ThemeErrorHandler.handleAjaxError(xhr, status, error, 'Wishlist sync');
                        }
                    }
                });
            }
        ...
        getCustomerList: function (callback) {
            if (theme.customer) {
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        if (window.ThemeErrorHandler) {
                            ThemeErrorHandler.handleAjaxError(xhr, status, error, 'Wishlist fetch');
                        }
                    }
                });
            }
        ...
        addCustomerItem: function (id, handle, callback) {
            if (theme.customer) {
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        if (window.ThemeErrorHandler) {
                            ThemeErrorHandler.handleAjaxError(xhr, status, error, 'Wishlist add item');
                        }
                    }
                });
            }
        ...
        removeCustomerItem: function (id, callback) {
            if (theme.customer) {
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        if (window.ThemeErrorHandler) {
                            ThemeErrorHandler.handleAjaxError(xhr, status, error, 'Wishlist remove item');
                        }
                    }
                });
            }
        ...
        clearCustomerItem: function (callback) {
            if (theme.customer) {
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        if (window.ThemeErrorHandler) {
                            ThemeErrorHandler.handleAjaxError(xhr, status, error, 'Wishlist clear');
                        }
                    }
                });
            }
    ...
    StoreListsEnginePopup.prototype = $.extend({}, StoreListsEnginePopup.prototype, {
        ...
        _getProducts: function (items, callback) {
            ...
            $.ajax({
                ...
                error: function (xhr, status, error) {
                    if (window.ThemeErrorHandler) {
                        ThemeErrorHandler.handleAjaxError(xhr, status, error, 'Wishlist products fetch');
                    }
                }
            });
        },
        ...
        _resultToHTMLMini: function ($items, data, callback) {
            ...
            this.eachProducts(data, (product, variant, image) => {
                ...
                $links.attr('href', themeRootPath('products/' + product.handle + '?variant=' + variant.id));
    ...
    ProductOptions.prototype = $.extend({}, ProductOptions.prototype, {
        ...
        _loadJSON: function ($product, json, callback, animate) {
            ...
            if (json) {
                ...
                var xhr = $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        if (window.ThemeErrorHandler) {
                            ThemeErrorHandler.handleAjaxError(xhr, status, error, 'Product JSON fetch');
                        }
                    },
                    complete: function () {
        ...
        _updateLinks: function ($product, data) {
            var url = themeRootPath('products/' + data.json.handle + '?variant=' + data.update_variant.id);
        ...
        _updatePickupAvailable: function ($product, data) {
            ...
            fetch(`${theme.routes.root_url}products/${handle}/?variant=${data.update_variant.id}&view=variant_data`)
                ...
                .catch(e => {
                    if (window.ThemeErrorHandler) {
                        ThemeErrorHandler.handleFetchError(e, 'Pickup availability fetch');
                    }
                });
        }
    });
    ...
    class CartData {
        ...
        updateData(parentResponse) {
            ...
            return fetch(`${this.rootURL}.js`)
                ...
                .catch(error => {
                    if (window.ThemeErrorHandler) {
                        ThemeErrorHandler.handleFetchError(error, 'Cart data update');
                    }
                    throw error;
                });
        }
            ...
            return fetch(`${this.rootURL}/add.js`, requestParams)
                .then(response => {
                    if (response.ok) {
                        ...
                        // Handle non-OK responses (e.g., product unavailable)
                        return response.json().then(data => {
                            if (window.ThemeErrorHandler) {
                                ThemeErrorHandler.handleCartError(data, 'Add to cart');
                            }
                            return response;
                        });
                    }
                ...
                .catch(error => {
                    if (window.ThemeErrorHandler) {
                        ThemeErrorHandler.handleFetchError(error, 'Add to cart');
                    }
                    throw error;
                });
        }
        ...
        changeItemById(id, quantity) {
            ...
            return fetch(`${this.rootURL}/change.js`, requestParams)
                ...
                .catch(error => {
                    if (window.ThemeErrorHandler) {
                        ThemeErrorHandler.handleFetchError(error, 'Change cart item');
                    }
                    throw error;
                });
        }
        ...
        changeItemByLine(line, quantity) {
            ...
            return fetch(`${this.rootURL}/change.js`, requestParams)
                ...
                .catch(error => {
                    if (window.ThemeErrorHandler) {
                        ThemeErrorHandler.handleFetchError(error, 'Change cart item by line');
                    }
                    throw error;
                });
        }
        ...
        getPageContent() {
            ...
            return fetch(`${this.rootURL}?view=ajax`, requestParams)
                ...
                .catch(error => {
                    if (window.ThemeErrorHandler) {
                        ThemeErrorHandler.handleFetchError(error, 'Cart page content fetch');
                    }
                    throw error;
                });
        }
        ...
        getPopupContent() {
            ...
            return fetch(`${this.rootURL}?view=popup`, requestParams)
                ...
                .catch(error => {
                    if (window.ThemeErrorHandler) {
                        ThemeErrorHandler.handleFetchError(error, 'Cart popup content fetch');
                    }
                    throw error;
                });
        }
    ...
    class CartViewer extends CartData {
        ...
        updateFreeShipping() {
            ...
            if (!$freeShipping.length || this.currentData.total_price === undefined) {
                return;
            }

            const threshold = theme.cart_free_shipping_value || 0;
            const total = this.currentData.total_price;
            const money = Math.max(threshold - total, 0);
            const progress = threshold > 0 ? Math.min(total / (threshold / 100), 100) : 100;
            const isComplete = money <= 0 || progress >= 100;
            const message = money > 0
                ? theme.strings.cart.general.free_shipping_html.replace('{{ value }}', Shopify.formatMoney(money, theme.moneyFormat))
                : theme.strings.cart.general.free_shipping_complete;

            $freeShipping.each(function () {
                ...
                $container
                    ...
                    .css({
                        width: progress + '%',
                        backgroundColor: isComplete ? '#5A31F4' : '#F8BD19'
                    });

                $container
                    .find('.free-shipping__text')
                    .toggleClass('is-complete', isComplete)
                    .css('color', isComplete ? '#ffffff' : '')
                    .find('[data-js-text]')
                    .html(message);
            });
        }
    ...
    class CartController extends CartViewer {
        ...
        popupController() {
            ...
            theme.Popups.addHandler('cart', 'call.before', $popup => {
                ThemeDebug.log('[CART POPUP] ' + new Date().toISOString() + ' call.before - popup opening');
            });

            theme.Popups.addHandler('cart', 'call.visible', $popup => {
                ThemeDebug.log('[CART POPUP] ' + new Date().toISOString() + ' call.visible - popup now visible');
            ...
            theme.Popups.addHandler('cart', 'call.after', $popup => {
                ThemeDebug.log('[CART POPUP] ' + new Date().toISOString() + ' call.after - popup fully opened');
            });

            theme.Popups.addHandler('cart', 'close.before', function ($popup, $target) {
                const closeSource = $target ? ($target.attr('class') || $target[0].tagName) : 'unknown';
                const stack = new Error().stack;
                ThemeDebug.log('[CART POPUP] ' + new Date().toISOString() + ' close.before - popup closing', {
                    source: closeSource,
                    target: $target ? $target[0] : null,
                    cartCloseByButton: _.cartCloseByButton,
                    cartIntentionalOpen: _.cartIntentionalOpen
                });
                ThemeDebug.log('[CART POPUP] close.before stack trace:', stack);
            });

            theme.Popups.addHandler('cart', 'close.after', function ($popup, $target) {
                const closeSource = $target ? ($target.attr('class') || $target[0].tagName) : 'unknown';
                ThemeDebug.log('[CART POPUP] ' + new Date().toISOString() + ' close.after - popup closed', {
                    source: closeSource,
                    wasClosedByButton: _.cartCloseByButton
                });
            });
        }
        ...
        preventAutoClose() {
            ...
            this.cartCloseByButton = false;
            this.cartForceOpen = false;
            this.cartIntentionalOpen = false;

            $body.on('click', '.popup-cart__close[data-js-popup-close]', function () {
                ThemeDebug.log('[CART POPUP] ' + new Date().toISOString() + ' Close button clicked by user');
                _.cartCloseByButton = true;
            });

            // Track clicks on background overlay
            $body.on('click', '[data-js-popup-bg]', function () {
                ThemeDebug.log('[CART POPUP] ' + new Date().toISOString() + ' Background overlay clicked');
            });
        }
        ...
        addToCartController() {
            ...
            $body.on('click', this.selectorButtonAdd, function (e) {
                ...
                ThemeDebug.log('[ADD TO CART DEBUG] Button clicked', {
                    buttonStatus: attrButtonStatus,
                    hasActiveClass: $this.hasClass('active'),
                    isDisabled: $this.attr('disabled'),
                    willProcess: attrButtonStatus !== 'added' && !$this.hasClass('active')
                });
                            ...
                            .then(response => {
                                function callback() {
                                    ...
                                    _.updateCart().then(() => {
                                        ...
                                        ThemeDebug.log('[ADD TO CART DEBUG] Cart updated, button set to added status. Will re-enable in 2s.');
                                        setTimeout(() => {
                                            ThemeDebug.log('[ADD TO CART DEBUG] Re-enabling button now', {
                                                btnsLength: $btns.length,
                                                btnsConnected: $btns[0] ? $btns[0].isConnected : 'N/A',
                                                attrButtonStatus: attrButtonStatus
                                            });
        ...
        enableButton($btns, status) {
            ThemeDebug.log('[ADD TO CART DEBUG] enableButton called', {
                btnsLength: $btns.length,
                status: status,
                currentStatus: $btns.attr('data-button-status')
            });
            ...
            ThemeDebug.log('[ADD TO CART DEBUG] enableButton done', {
                newStatus: $btns.attr('data-button-status'),
                isDisabled: $btns.attr('disabled')
            });
        }

        showPopup() {
            const $cartPopup = $('[data-js-popup-name="cart"]');
            ThemeDebug.log('[CART POPUP] ' + new Date().toISOString() + ' showPopup() called', {
                popupExists: $cartPopup.length > 0,
                hasShowClass: $cartPopup.hasClass('show'),
                hasVisibleClass: $cartPopup.hasClass('visible')
            });
            this.cartIntentionalOpen = true;
            ThemeDebug.log('[POPUP TRACK] Auto Open Cart (CartController)');
            theme.Popups.callByName('cart');
        }

        goToProductPage($product) {
            location.href = themeRootPath('products/' + $product.attr('data-product-handle'));
        }
